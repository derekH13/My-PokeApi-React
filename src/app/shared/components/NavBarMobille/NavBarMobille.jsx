...
function NavBarMobille(){
    return(
        <div>
            

<div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600 nav-mobille">
    <div className="flex justify-center h-full max-w-lg  mx-auto">
        ...
        <div className="flex items-center justify-center">
            ...
            <button data-tooltip-target="tooltip-new" type="button" className="inline-flex items-center justify-center w-14 h-14 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
            <a href="#buscar">
                <Link to='/PokeDex'>
